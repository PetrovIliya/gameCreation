...
float speedInit(std::vector<sf::Vector2f> &speed, PRNG generator)
{
    for (int i = 0; i < QUANTITY_OF_BALLS; i++)
    {
        speed.push_back({getRandomFloat(generator, 50, 350), getRandomFloat(generator, 50, 350)});
    }
}
